    ...
    public class NetworkThirdPersonController : NetworkBehaviour
    {
        ...
        private void GroundedCheck()
        {
            ...
            if (_hasAnimator)
            {
                ...
                //SetAnimGroundedServerRpc(Grounded);
            }
        }
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                if (_hasAnimator)
                {
                    ...
                    //SetAnimJumpServerRpc(false);
                    //SetAnimFreeFallServerRpc(false);
                }
        ...
        [ServerRpc]
        private void SetanimMotionSpeedServerRpc(float motionSpeed)
        {
            _animator.SetFloat(_animIDMotionSpeed, motionSpeed);
        }

        [ServerRpc]
        private void SetAnimSpeedServerRpc(float speed)
        {
            _animator.SetFloat(_animIDSpeed, speed);
        }

        [ServerRpc]
        private void SetAnimGroundedServerRpc(bool grounded)
        {
            _animator.SetBool(_animIDGrounded, grounded);
        }

        [ServerRpc]
        private void SetAnimFreeFallServerRpc(bool fall)
        {
            _animator.SetBool(_animIDFreeFall, fall);
        }

        [ServerRpc]
        private void SetAnimJumpServerRpc(bool jump)
        {
